...
1. **Create Failing Test Case**
   ...
   - Use the `ggcoder:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **ggcoder:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **ggcoder:verification-before-completion** - Verify fix worked before claiming success
